            ...
            <motion.div
              ...
              <motion.div className="grid grid-cols-2 gap-2 wrap">
                <motion.div
                  ...
                  <div className="w-12 " >
                    <StaticImage src="../../images/components/monitor.png" alt="Monitores" />
                  </div>
                ...
                <motion.div
                  className="w-auto flex flex-col items-center justify-self-center text-primary text-sm ">
                  <div className="w-12 " >
                    <StaticImage src="../../images/components/proyector.png" alt="Tablets" />
                  </div>
                  <p className=" ml h-full flex items-center">Proyectores</p>
                </motion.div>
              </motion.div>
            </motion.div>
          )}
...
export default ViewSonicDistributor
