            ...
            <motion.div
              ...
              <motion.div className="grid grid-cols-2 gap-2 wrap">
                <motion.div
                  ...
                  <div className="w-12 " >
                    <StaticImage src="../../images/components/monitor.png" alt="Television" />
                  </div>
                  <p className=" ml h-full flex items-center">Televisores</p>
                </motion.div>
              </motion.div>
            </motion.div>
          )}
...
export default TdSystemsDistributor
