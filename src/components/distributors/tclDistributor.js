...
function TclDistributor() {
  const [selectedId, setSelectedId] = useState(false)
  const link = '../../images/fotos_marca/tcl.png'
            ...
            <motion.div
              ...
              <motion.div className="grid grid-cols-2 gap-2 wrap">
                <motion.div
                  ...
                  <div className="w-12 " >
                    <StaticImage src="../../images/components/smartphone.png" alt="Smartphone" />
                  </div>
                  <p className=" ml h-full flex items-center">Smartphones</p>
                </motion.div>
                <motion.div
                  className="w-auto flex flex-col items-center justify-self-center text-primary text-sm ">
                  <div className="w-12 " >
                    <StaticImage src="../../images/components/tablet.png" alt="Tablets" />
                  </div>
