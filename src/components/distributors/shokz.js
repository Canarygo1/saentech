            ...
            <motion.div
              ...
              <motion.div className="grid grid-cols-2 gap-2 wrap">
                <motion.div
                  ...
                  <p className=" ml h-full flex items-center">Auriculares oseos</p>
                </motion.div>
              </motion.div>
            </motion.div>
          )}
...
export default ShokzDistributor
