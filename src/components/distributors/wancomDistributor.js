...
function WancomDistributor() {
  const [selectedId, setSelectedId] = useState(false)
  const link = '../../images/fotos_marca/wacon.png'
            ...
            <motion.div
              ...
              <motion.div className="grid grid-cols-2 gap-2 wrap">
                <motion.div
                  ...
                  <div className="w-12 " >
                    <StaticImage src="../../images/components/tableta-digitalizadora.png" alt="A kitten" />
                  </div>
                  <p className=" ml h-full flex items-center">Tabletas digitalizadoras</p>
                </motion.div>
              </motion.div>
            </motion.div>
          )}
...
export default WancomDistributor
