...
const FourSection = () => (
  <div className="w-full hidden md:flex md:flex-col md:text-center text-white text-7xl bg-opacity-10 py-14">
    Opiniones de nuestros clientes
      <Separator dataHeigth="50px" dataWidth="1px" />
      <div className='flex justify-evenly'>
          <div className='rounded-lg border-2 border-secondary card-opiniones p-9 flex flex-col items-center'>
