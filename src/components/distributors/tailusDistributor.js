            ...
            <motion.div
              ...
              <motion.div className="grid grid-cols-2 gap-2 wrap">
                <motion.div
                  ...
                  <div className="w-12 " >
                    <StaticImage src="../../images/components/gaming-chair.png" alt="Smartphone" />
                  </div>
                  <p className=" ml h-full flex items-center">Sillas gaming</p>
                </motion.div>
...
export default TailusDistributor
